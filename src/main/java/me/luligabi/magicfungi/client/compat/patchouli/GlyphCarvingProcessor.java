...
public class GlyphCarvingProcessor implements IComponentProcessor {

    private GlyphRecipe recipe;
    private String text;

    @Override
    public void setup(IVariableProvider variables) {
        String recipeId = variables.get("recipe").asString();
        recipe = (GlyphRecipe) MinecraftClient.getInstance().world.getRecipeManager().get(new Identifier(recipeId)).orElseThrow(() -> new IllegalArgumentException("Invalid recipe: " + recipeId));
