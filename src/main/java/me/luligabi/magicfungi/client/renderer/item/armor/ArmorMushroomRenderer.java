...
public class ArmorMushroomRenderer  {
    ...
    public static void renderHelmet(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, LivingEntity playerEntity, int light, BipedEntityModel<LivingEntity> contextModel) {
        matrixStack.push();
        ...
        BLOCK_RENDER_MANAGER.renderBlockAsEntity(RED_MUSHROOM_STATE, matrixStack, vertexConsumerProvider, light, LivingEntityRenderer.getOverlay(playerEntity, 0.0F));
        matrixStack.pop();
    }

    public static void renderChestplate(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, LivingEntity playerEntity, int light, BipedEntityModel<LivingEntity> contextModel) {
        matrixStack.push();
