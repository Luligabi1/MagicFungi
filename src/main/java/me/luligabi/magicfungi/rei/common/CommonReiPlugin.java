...
public class CommonReiPlugin implements REIServerPlugin {
    ...
    public void registerMenuInfo(MenuInfoRegistry registry) {
        ...
        registry.register(MAGIC_CONDENSING, MagicCondenserScreenHandler.class, SimpleMenuInfoProvider.of(MagicCondenserMenuInfo::new));
    }
    ...
    public void registerDisplaySerializer(DisplaySerializerRegistry registry) {
        ...
        registry.register(MAGIC_CONDENSING, MagicCondenserDisplay.Serializer.INSTANCE);
    }
