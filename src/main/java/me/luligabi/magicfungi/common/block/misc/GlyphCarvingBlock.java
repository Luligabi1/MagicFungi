...
public class GlyphCarvingBlock extends BlockWithEntity {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new GlyphCarvingBlockEntity(pos, state);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof GlyphCarvingBlockEntity) {
                ItemScatterer.spawn(world, pos, (GlyphCarvingBlockEntity) blockEntity);
