...
public class SpellDiscoveryResultSlot extends CraftingResultSlot {

    private final CraftingInventory input;
    private final PlayerEntity player;

    public SpellDiscoveryResultSlot(PlayerEntity player, CraftingInventory input, Inventory inventory, int index, int x, int y) {
